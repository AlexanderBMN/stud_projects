...
gnome-terminal -- bash -c "source /home/ameise/Yassine_GIT/ws_os/devel/setup.bash && \
roslaunch ouster_ros ouster.launch sensor_hostname:=192.168.42.129 lidar_mode:=1024x20 viz:=false sensor_name:=OS0_LEFT tf_prefix:=1\
metadata:=/home/ameise/Yassine_GIT/192.168.42.129.json"

# Lidar OS1 169.254.141.135
gnome-terminal -- bash -c "source /home/ameise/Yassine_GIT/ws_os/devel/setup.bash && \
roslaunch ouster_ros ouster.launch sensor_hostname:=192.168.42.62 lidar_mode:=1024x20 viz:=false sensor_name:=OS0_RIGHT tf_prefix:=2 \
metadata:=/home/ameise/Yassine_GIT/192.168.42.62.json"


# Lidar OS2 169.254.86.233
gnome-terminal -- bash -c "source /home/ameise/Yassine_GIT/ws_os/devel/setup.bash && \
roslaunch ouster_ros ouster.launch sensor_hostname:=192.168.42.187 lidar_mode:=1024x10 viz:=false sensor_name:=OS1_TOP \
metadata:=/home/ameise/Yassine_GIT/192.168.42.187.json"
